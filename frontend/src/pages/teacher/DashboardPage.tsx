...
import { ROUTES } from "../../constants"; // Import ROUTES chuẩn
...
const DashboardPage = () => {
  ...
  return (
    <div className="flex min-h-screen bg-slate-50 text-slate-800 font-sans">
      {/* 1. SIDEBAR CHUẨN */}
      <SidebarTeacher activeItem="Dashboard" />

      {/* 2. MAIN CONTENT (Đã căn lề ml-[270px] để né Sidebar) */}
      <main className="ml-[270px] flex-1 p-8 md:p-12 overflow-y-auto">
        {/* HEADER */}
